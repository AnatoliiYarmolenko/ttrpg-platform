...
export default function VttFloatingCall({ sessionId }) {
  ...
  return (
    ...
    >
      <div className="flex-1 overflow-y-auto px-3 py-2 [&_.bg-gray-100]:!bg-brand-medium/30 [&_.border-gray-200]:!border-brand-light/20 [&_.text-gray-500]:!text-brand-light/70 [&_.text-gray-900]:!text-white">
